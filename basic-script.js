...
// const pawan = bio("Pawan", "Nicholls, Canberra")
// console.log(pawan)
...
//   add: "sydney",
// }
// person.age= 20  // assign
// // console.log(person.name)
// delete person.add // delete
// console.log(person)
...
//   return `Hi I am ${name} and i live in ${add}` 
// }
// const ParentInfo = ({f, m}) =>{
//   return `The person is the son of ${f} and ${m}`
// }
// const bio = ({name, title="", add, ...rest}) => {
//   return `Hi I am ${title} ${name} and i live in ${add}`+ ParentInfo(rest)
// }
...
// const siwakotiBio = bio({
//   name: "Siwakoti",
//   add: "Nicholls",
// })


// console.log(pawanBio)
// console.log(siwakotiBio)
...
// const {num, ...rest} = combo

// console.log(combo, rest)

// // const proArg = Object.keys(combo)
// const proArg = Object.values(combo)
...
// const dt = new Date("1994-11-26")// const val = dt.getFullYear();
// const val = dt.getDay()
...
// create a function that takes food name and expire date and returns like xyz food is expire or not expired and simply console.log 

// const abc =({food, exDate}) =>{

//   const dt = new Date(exDate)
//  const currentDate = new Date (Date.now())

//  const oneDay = 24 * 60 * 60 * 1000; // hours*minutes*seconds*milliseconds
//  const exDays = Math.floor((currentDate - dt)/oneDay)
//  const leftDays = Math.floor((dt - currentDate)/oneDay)
 
  
//   if (currentDate > dt){
//   return `${food} is expired on ${dt}. It is by ${exDays} days`
//   }
//   else{
//     return `${food} is not expired on ${dt}. It has ${leftDays} days left to expire.`
//   }
 
//   // Above code in ternary Operator 
//   // (currentDate > dt) ?
//   // `${food} is expired on ${dt}. It is by ${exDays} days`
//   //  :
//   //     `${food} is not expired on ${dt}. It has ${leftDays} days to expire`
...
// console.log("4. consloe")

// setTimeout(()=>{
//   console.log("5. Inside second set time out")
// }, 0)
